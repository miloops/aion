    ...
    def test_filter_invalid_field(self, interpreter, sample_data):
        ...
        program = {
            "pipeline": [
                {
                    "task": "filter",
                    "condition": {"field": "nonexistent", "operator": ">", "value": 30},
                }
            ]
        }
...
class TestSortTask:
    ...
    def test_sort_ascending(self, interpreter, sample_data):
        ...
        program = {
            "pipeline": [
                {"task": "sort", "operation": {"field": "age", "order": "asc"}}
            ]
        }
...
class TestTransformTask:
    ...
    def test_field_rename(self, interpreter, sample_data):
        ...
        program = {
            "pipeline": [
                {"task": "transform", "mapping": {"user_id": "id", "full_name": "name"}}
            ]
        }
            ...
            "pipeline": [
                {
                    "task": "transform",
                    "mapping": {
                        "description": {"concat": ["name", " (", "age", " years old)"]}
                    },
                }
            ]
        }
            ...
            "pipeline": [
                {
                    "task": "aggregate",
                    "group_by": ["status"],
                    "aggregations": {"score": "sum", "age": "mean"},
                }
            ]
        }
...
class TestExportTask:
    ...
    def test_export_csv(self, interpreter, sample_data):
        ...
        try:
            program = {
                "pipeline": [{"task": "export", "file_path": tmp_path, "format": "csv"}]
            }
        ...
        program = {
            "pipeline": [
                ...
                {"task": "sort", "operation": {"field": "score", "order": "desc"}},
                {
                    ...
                    "mapping": {
                        "user_id": "id",
                        "performance": {"concat": ["name", " - Score: ", "score"]},
                    },
                },
            ]
        }
...
class TestErrorHandling:
    ...
    def test_invalid_task_type(self, interpreter, sample_data):
        ...
        program = {"pipeline": [{"task": "nonexistent_task", "some_config": "value"}]}
