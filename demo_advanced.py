...
def main():
    ...
    data = pd.DataFrame({
        ...
        'created_at': ['2023-01-15', '2023-02-20', '2023-01-10', '2023-03-05', '2023-02-28', '2023-01-25', '2023-03-15', '2023-02-10'],
        'activity_score': [85, 45, 92, 78, 60, 88, 95, 52],
        'department': ['Engineering', 'Marketing', 'Engineering', 'Sales', 'HR', 'Engineering', 'Sales', 'Marketing']
    })
