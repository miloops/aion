...
from .validators import AIONValidator
...
class AIONInterpreter:
    ...
    def execute(
        self, program: Dict[str, Any], input_data: Optional[Any] = None
    ) -> ExecutionResult:
        ...
        return ExecutionResult(
            data=data, logs=logs, errors=errors, execution_plan=execution_plan
        )
